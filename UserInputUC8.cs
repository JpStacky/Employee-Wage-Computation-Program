...
namespace EmployeeWageComputationProgram
{
    public class UserInputUC8
    {
        ...
        public UserInputUC8(int wage_Per_Hour, int no_Of_Days_Per_Month, int work_Hour_Per_Month)
        {
            this.wage_Per_Hour = wage_Per_Hour;
            this.work_Hour_Per_Month = work_Hour_Per_Month;
            this.no_Of_Days_Per_Month = no_Of_Days_Per_Month;
        }
        public void getAttendance()
        {
            ...
            while (true)
            //for (int i = 0; i < 20 && count_Work_Hour < 100; i++)
            {
                ++count_Number_Of_Day;
        ...
        {
            int total_Wage = count_Work_Hour * wage_Per_Hour;
